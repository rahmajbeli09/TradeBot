...
$tests = @(
    ...
    [PSCustomObject]@{question="Différence entre msgType 53 et 16"; expectedMsgType=$null; expectedChamp=$null; testType="comparative"; shouldRefuse=$true},
    [PSCustomObject]@{question="Comparaison msgType A3 versus 03"; expectedMsgType=$null; expectedChamp=$null; testType="comparative"; shouldRefuse=$true},
    
    # Tests de champs inexistants
    [PSCustomObject]@{question="Explique le champ Inexistant du msgType 53"; expectedMsgType="53"; expectedChamp="Champ Inexistant"; testType="champ-inexistant"; shouldRefuse=$true},
    [PSCustomObject]@{question="Quel est le rôle du Champ 99 du msgType 16"; expectedMsgType="16"; expectedChamp="Champ 99"; testType="champ-inexistant"; shouldRefuse=$true}
)
